...
| ------------- |:------------------:| --------------| --------------| --------------|-------------------------|
|1|Веб-приложение|||||
| 1.1    | Регистрация пользователя | “Приложение должно иметь функцию регистрации нового пользователя" |Миронов Д.С.|https://habr.com/ru/company/UXDepot/blog/134595/|Регистрация нового пользователя|
|1.2|Авторизация пользователя| “Приложение должно иметь функцию авторизации пользователя"|Миронов Д.С.|https://habr.com/ru/company/avanpost/blog/480576/|Авторизация зарегистрированного пользователя в приложении|
|1.3|Услуга “бронирование номера”|“Приложение должно иметь возможность предоставления пользователю услуги бронирования номера в отеле”|Марданян А.С.|https://studwood.net/1099901/turizm/bronirovanie_gostinichnyh_uslug|Бронирование номера|
...
|1.8|Услуга “бронирование номера с определенным числом людей”|“Приложение должно позволять пользователю бронировать номера с желаемым количеством людей”|Миронов Д.С.|https://studwood.net/1099901/turizm/bronirovanie_gostinichnyh_uslug|Выбор количества людей|
|1.9|Услуга “бронирование номера в определенный день”|“Приложение должно позволять пользователю бронировать номера на определенную дату”|Семёнов Д.Ю.|https://studwood.net/1099901/turizm/bronirovanie_gostinichnyh_uslug|Выбор даты|
|2|Веб-интерфейс|||||
| 2.1    | Регистрация пользователя | “Приложение должно иметь функцию регистрации нового пользователя" |Миронов Д.С.|https://habr.com/ru/company/UXDepot/blog/134595/|Регистрация нового пользователя|
|2.2|Авторизация пользователя| “Приложение должно иметь функцию авторизации пользователя"|Миронов Д.С.|https://habr.com/ru/company/avanpost/blog/480576/|Авторизация зарегистрированного пользователя в приложении|
|2.3|Услуга “бронирование номера”|“Приложение должно иметь возможность предоставления пользователю услуги бронирования номера в отеле”|Марданян А.С.|https://studwood.net/1099901/turizm/bronirovanie_gostinichnyh_uslug|Бронирование номера|
...
|2.8|Услуга “бронирование номера с определенным числом людей”|“Приложение должно позволять пользователю бронировать номера с желаемым количеством людей”|Миронов Д.С.|https://studwood.net/1099901/turizm/bronirovanie_gostinichnyh_uslug|Выбор количества людей|
|2.9|Услуга “бронирование номера в определенный день”|“Приложение должно позволять пользователю бронировать номера на определенную дату”|Марданян А.С.|https://studwood.net/1099901/turizm/bronirovanie_gostinichnyh_uslug|Выбор даты|
|2.10|Возможность прокрутки к началу страницы|“Приложение должно позволять пользователю прокручивать страницу к самому началу”|Семёнов Д.Ю.||Прокрутка к началу страницы|
|2.11|Интуитивно-понятный интерфейс|“Приложение должно быть интуитиво- понятно для пользователя”|Марданян А.С.||Интуитивно-понятный интерфейс|
|3|Веб-приложение для администратора|||||
| 3.1    |Интуитивно-понятный интерфейс|“Приложение должно быть интуитиво-понятно для пользователя”|Марданян А.С.||Интуитивно-понятный интерфейс|
|3.2|Регистрация пользователя | “Приложение должно иметь функцию регистрации нового пользователя"|Миронов Д.С.|https://habr.com/ru/company/UXDepot/blog/134595/|Регистрация нового пользователя|
|3.3|Добавление новых отелей|“Приложение должно иметь функцию добавления отелей"|Анваржонов Ж.||Добавление отеля в список|
|3.4|Редактирование отелей|“Приложение должно иметь функцию редактирования отелей"|Марданян А.С.||Редактирование существующего отеля|
|4|Правовые нормы регулирования деятельности компании|||||
|4.1|Полное информирование посетителя о услугах отеля|Исполнитель обязан довести до сведения потребителя информацию об оказываемых им услугах(Постановление Правительства РФ от 18 ноября 2020 г. N 1853 "Об утверждении Правил предоставления гостиничных услуг в Российской Федерации")|Марданян А.С.|https://base.garant.ru/74929324/|Не должно быть выявлено нарушений|


# Заключение
В результате выполнения первого блока практических работ (с первой по четвертую включительно) были определены пользовательские, функциональные и нефункциональные требования, продемонстрирован процесс ведения задач проекта, создан портрет пользователя и целевой аудитории, построены Use case диаграмма, диаграмма последовательностей.
